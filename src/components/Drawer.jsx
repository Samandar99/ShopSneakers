            ...
            <div className="drawer">
                <div className="items">
                    ...
                    <div className="cartItem d-flex align-center mb-20">
                        <div style={{ backgroundImage: 'url(/img/sneakers/image2.jpg)' }} className="cartItemImg">
                        </div>
                    ...
                    <div className="cartItem d-flex align-center mb-20">
                        ...
                        <div style={{ backgroundImage: 'url(/img/sneakers/image3.jpg)' }} className="cartItemImg">
                        </div>
